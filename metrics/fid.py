...
def compute_frechet_distance(X1, X2):
    """
    Frechet distance between two datasets that are both assumed Gaussian
    

    """
    mu1, cov1 = fit_gaussian(X1)
    mu2, cov2 = fit_gaussian(X2)
    return calculate_frechet_distance(mu1,cov1,mu2,cov2)

def fit_gaussian(act):
